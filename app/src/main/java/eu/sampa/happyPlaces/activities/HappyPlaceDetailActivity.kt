...
class HappyPlaceDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(happyPlaceDetailModel != null) {
            ...
            // Placing the correct details of the clicked record
            iv_place_image.setImageURI(Uri.parse(happyPlaceDetailModel.image)) // Uri because the image in the HappyPlaceModel is of type String
            tv_description.text = happyPlaceDetailModel.description
            tv_location.text = happyPlaceDetailModel.location
            tv_date.text = happyPlaceDetailModel.date

            // OnClickListener for our Button for the Map
