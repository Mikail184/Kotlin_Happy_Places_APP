package eu.sampa.happyPlaces.database
...
class DatabaseHandler(context: Context) :
    ...
    companion object {
        ...
        //All the Columns names (same ones as in HappyPlaceModel)
    ...
    override fun onUpgrade(db: SQLiteDatabase?, oldVersion: Int, newVersion: Int) {
     ...
     // Function to insert Happy Place details to SQLite Database.
    ...
    // Retrieves the entries of the database
